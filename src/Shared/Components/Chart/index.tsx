...
//     {
//       label: 'Year chart',
//       data: [200, 500, 700, 200, 500, 600, 600, 600, 400, 200, 100, 500],
//       backgroundColor: '#45A29E',
//     },
//   ],
// };

const date: any = moment().subtract(1, 'months')

export default function Chart(props: any) {
    const [startDate, setStartDate] = useState("2021-11-20")
    const [endDate, setEndDate] = useState("2022-11-20")
        ...
        .pipe(
            ...
            if(data.success){
                setData({
                    ...
                    {
                        label: fromCurrency,
                        data: [Object.values(data.rates[dates[0]])[0], Object.values(data.rates[dates[1]])[0], Object.values(data.rates[dates[2]])[0], Object.values(data.rates[dates[3]])[0], Object.values(data.rates[dates[4]])[0], Object.values(data.rates[dates[5]])[0], Object.values(data.rates[dates[6]])[0], Object.values(data.rates[dates[7]])[0], Object.values(data.rates[dates[8]])[0], Object.values(data.rates[dates[9]])[0], Object.values(data.rates[dates[10]])[0], Object.values(data.rates[dates[11]])[0]],
                        backgroundColor: '#45A29E',
                    },
                    ],
                }) 
